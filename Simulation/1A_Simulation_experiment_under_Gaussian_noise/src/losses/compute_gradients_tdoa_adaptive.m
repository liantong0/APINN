...
% Compute adaptive APINN gradients by backpropagating data and physics losses.
    ...
    if isfield(train_params, 'lambda_smooth') && train_params.lambda_smooth > 0
        ...
        if nPairs > 0
            % loss_smooth = lambda * mean(sum(dY.^2, 2))
