function [loss, gradients] = compute_loss_and_gradients_tdoa_fixed(net, X_norm, X_raw, ...
                                                        ...
                                                        params, train_params)
% Compute fixed-weight PINN loss and gradients with aggregated physics loss.
    ...
    loss.physics = loss_tdoa + loss_camera + loss_detector + loss_depth + loss_consistency;
    loss.total = loss_data + loss.physics;
