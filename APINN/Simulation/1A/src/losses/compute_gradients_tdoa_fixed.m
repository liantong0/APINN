...
% Compute fixed-weight PINN gradients by backpropagating data and physics losses.
    ...
    % 4. Detector constraint gradient
    for i = 1:batch_size
        try
            U_I = X_raw(i, 6);
            U_II = X_raw(i, 7);
    ...
    % 6. Consistency constraint gradient
